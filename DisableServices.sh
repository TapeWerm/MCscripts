...
# Exit if error
set -e
scripts=(DisableServices.sh MCbackup.sh MCBEautoUpdate.sh MCBEbackup.sh MCBE_Bot.sh MCBEgetZIP.sh MCBElog.sh MCBEupdate.sh MCcolor.sed MCgetJAR.sh MCrunCmd.sh MCstop.sh MoveServers.sh)

...
scripts+=(disable_services.sh enable_services.sh mc_backup.sh mc_cmd.sh mc_color.sed mc_getjar.sh mc_stop.sh mcbe_autoupdate.sh mcbe_backup.sh mcbe_getzip.sh mcbe_log.sh mcbe_update.sh move_servers.sh)
